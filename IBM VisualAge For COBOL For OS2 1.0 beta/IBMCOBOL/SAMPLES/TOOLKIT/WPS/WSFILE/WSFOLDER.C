...
******************************************************************************/
   ...
   const char szHelpLibrary[] =          "wsfolder.hlp";
 ...
 *   PARAMETERS:
 *
 *      HWND - hwnd of the first of multiple currently open view of this object
 *
 *   RETURNS:
 *
    ...
    else
    {
       if (ulOurs == pdrgInfo->cditem)
       {
          if (pdrgInfo->usOperation == DO_DEFAULT)
             mr = MRFROM2SHORT(DOR_DROP, (SHORT)DO_COPY);
          else
             mr = MRFROM2SHORT(DOR_DROP, (SHORT)pdrgInfo->usOperation);
       }
       else
       {
...
{
    /* M_WSFOLDERData *somThis = M_WSFOLDERGetData(somSelf); */
   M_WSFOLDERMethodDebug("M_WSFOLDER", "wsfoldM_wpclsInitData");
   ...
   if (!WinLoadString(WinQueryAnchorBlock(HWND_DESKTOP),
                      ...
                      ID_TITLE,
                      sizeof(szWSFOLDERClassTitle),
                      szWSFOLDERClassTitle))
...
SOM_Scope HMODULE  SOMLINK wsfold_clsQueryModuleHandle(M_WSFOLDER *somSelf)
{
   /* M_WSFOLDERData *somThis = M_WSFOLDERGetData(somSelf); */
   M_WSFOLDERMethodDebug("M_WSFOLDER", "wsfold_clsQueryModuleHandle");

   /* Return statement to be customized: */
   return;
}

SOM_Scope void  SOMLINK wsfold_wpclsInitData(M_WSFOLDER *somSelf)
{
   /* M_WSFOLDERData *somThis = M_WSFOLDERGetData(somSelf); */
   M_WSFOLDERMethodDebug("M_WSFOLDER", "wsfold_wpclsInitData");

   M_WSFOLDER_parent_M_WPFolder_wpclsInitData(somSelf);
}

SOM_Scope PSZ  SOMLINK wsfold_wpclsQueryTitle(M_WSFOLDER *somSelf)
{
    /* M_WSFOLDERData *somThis = M_WSFOLDERGetData(somSelf); */
    M_WSFOLDERMethodDebug("M_WSFOLDER", "wsfold_wpclsQueryTitle");

    return M_WSFOLDER_parent_M_WPFolder_wpclsQueryTitle(somSelf);
}

SOM_Scope ULONG  SOMLINK wsfold_wpclsQueryIconData(M_WSFOLDER *somSelf,
                                                   PICONINFO pIconInfo)
{
   /* M_WSFOLDERData *somThis = M_WSFOLDERGetData(somSelf); */
   M_WSFOLDERMethodDebug("M_WSFOLDER", "wsfold_wpclsQueryIconData");

   return M_WSFOLDER_parent_M_WPFolder_wpclsQueryIconData(somSelf, pIconInfo);
}

SOM_Scope BOOL  SOMLINK wsfold_wpclsQueryDefaultHelp(M_WSFOLDER *somSelf,
                                                     PULONG pHelpPanelId,
                                                     PSZ pszHelpLibrary)
{
    /* M_WSFOLDERData *somThis = M_WSFOLDERGetData(somSelf); */
   M_WSFOLDERMethodDebug("M_WSFOLDER", "wsfold_wpclsQueryDefaultHelp");

   return M_WSFOLDER_parent_M_WPFolder_wpclsQueryDefaultHelp(somSelf,
                                                             pHelpPanelId,
                                                             pszHelpLibrary);
}

SOM_Scope ULONG  SOMLINK wsfold_wpclsQueryDefaultView(M_WSFOLDER *somSelf)
{
   /* M_WSFOLDERData *somThis = M_WSFOLDERGetData(somSelf); */
   M_WSFOLDERMethodDebug("M_WSFOLDER", "wsfold_wpclsQueryDefaultView");

   return M_WSFOLDER_parent_M_WPFolder_wpclsQueryDefaultView(somSelf);
}

SOM_Scope ULONG  SOMLINK wsfold_wpclsQueryStyle(M_WSFOLDER *somSelf)
{
   /* M_WSFOLDERData *somThis = M_WSFOLDERGetData(somSelf); */
   M_WSFOLDERMethodDebug("M_WSFOLDER", "wsfold_wpclsQueryStyle");

   return M_WSFOLDER_parent_M_WPFolder_wpclsQueryStyle(somSelf);
}
/*************************** END OF wsfolder.c ********************************/
