.*==============================================================*\
.*                                                              *
.* img_file.ipf - Information Tag Language file the screens for *
.*              help on the file menu                           *
...
:p.The File menu contains the command that you use to open existing
image files.
The following
command appears in the File menu:
:parml tsize=15 break=none.
:pt.Open
:pd.Opens an existing image file
:eparml.
...
.*      res = PANEL_FILEOPEN                                    *
.*--------------------------------------------------------------*/
:h1 res=2220 name=PANEL_FILEOPEN.Open
:i2 refid=File.Open
...
display the available file types.  The Image Sample has set this field for
all file types.
:p.For more help, select a topic below.
.***********************************************************************
