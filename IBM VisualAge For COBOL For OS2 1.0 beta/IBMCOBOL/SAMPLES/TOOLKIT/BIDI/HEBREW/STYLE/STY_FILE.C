...
// BIDI
//
// Force default text for title and OK Button.
//
// fileDialog.pszTitle = szTitle;
// fileDialog.pszOKButton = szButton;
   fileDialog.pszTitle    = NULL;
...
// BIDI
//
// Force OpenFile dialog to come up right-to-left and in the
// national language.
//
   fileDialog.fl |= FDS_NATIONAL_LANGUAGE;
...
// BIDI
// Use default strings for title and OK Button.
//  fileDialog.pszTitle = szTitle;        /* String to display in title bar. */
//  fileDialog.pszOKButton = szButton;    /* String to display in OK button. */
    fileDialog.pszTitle = NULL   ;        /* Default string for   title bar. */
    fileDialog.pszOKButton = NULL    ;    /* Default string for   OK button. */
